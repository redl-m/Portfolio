  ...
  export class App implements AfterViewInit, OnDestroy {
    ...
    constructor(private viewportService: ViewportService) {} // Inject the service


    /**
     * Initializes sections and adds scroll listeners.
     */
    ngAfterViewInit(): void {
      ...
      this.viewportSub = this.viewportService.isMobileView$.subscribe(isMobile => {
        if (isMobile) {
          ...
          // Enable custom JS logic
          this.addScrollListeners();
        }
      });

      // Initial check for section index
